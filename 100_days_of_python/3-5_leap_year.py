...
# my solution
# TWO relations to consider and check
# 1st: year must be evenly divisible by 4, by 100,and by 400 to equal leap year.
# 2nd: year must be evenly divisilbe by 4 and not evenly divisible by 100 to equal leap year.  
